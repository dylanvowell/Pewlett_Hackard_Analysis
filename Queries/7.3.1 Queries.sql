...
e.last_name,
de.dept_no
INTO sales_dept_retire
FROM employees as e
INNER JOIN department_employees AS de
ON (de.emp_no = e.emp_no)
WHERE (e.birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (e.hire_date BETWEEN '1985-01-01' AND '1988-12-31')
AND (de.to_date = '9999-01-01') AND (de.dept_no = 'd007');

SELECT * FROM retirement_info
WHERE emp_no IN (10001);
...
WHERE (e.birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (e.hire_date BETWEEN '1985-01-01' AND '1988-12-31')
AND (de.to_date = '9999-01-01') AND (de.dept_no IN( 'd005','d007'));


DROP TABLE extra_list_1 CASCADE;
